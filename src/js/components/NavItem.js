...
export const NavItem = function (id, name) {
    ...
    // console.log("Elemes", $tooltipElems);
    // console.log("Eleme", $tooltipElem);

    $tooltipElems.forEach($elem => Tooltip($elem));

    /**
     * Handles the click event on the navigation item. updat the note panel's title, retrives the associated notes, 
    ...
    */
    ...
    $navItemField.addEventListener('keydown', function (event) {
        if(event.key === 'Enter') {
            ...
            // update
            // console.log("This is parent: ", this.parentElement);
            // const ID = this.parentElement.getAttribute('data-notebook');
            // console.log(ID);
            // console.log("This: ", id);
    ...
    $navItemDeleteBtn.addEventListener('click', function() {
        ...
        modal.onSubmit(function (isConfirm) {
            ...
            if(isConfirm) { // True means delete
                // console.log(isConfirm);
